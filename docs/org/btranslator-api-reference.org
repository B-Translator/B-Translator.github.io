...
** statistics
   ...
   #+begin_example
   curl 'https://btranslator.org/public/btr/report/statistics?lng=sq&origin=LibreOffice&project=cui'
   curl -H 'Accept: application/json' 'https://btranslator.org/public/btr/report/statistics?lng=sq'
   curl -H 'Content-type: application/json' -X POST https://btranslator.org/public/btr/report/statistics -d '{"lng": "sq"}'
   #+end_example
...
** project_stats
   ...
   #+begin_example
   curl 'https://btranslator.org/public/btr/report/project_stats?origin=LibreOffice&project=cui&lng=sq'
   curl -H 'Accept: application/json' 'https://btranslator.org/public/btr/report/project_stats?origin=LibreOffice&project=cui&lng=sq'
   curl -H 'Content-type: application/json' -X POST https://btranslator.org/public/btr/report/project_stats -d '{"origin": "LibreOffice", "project": "cui", "lng": "sq"}'
   #+end_example
...
** topcontrib
   ...
   #+begin_example
   curl -H 'Accept: application/json' 'https://btranslator.org/public/btr/report/topcontrib?lng=sq&period=week'
   curl -H 'Accept: application/json' -H 'Content-type: application/json' -X POST https://btranslator.org/public/btr/report/topcontrib -d '{"lng": "sq", "period": "week", "size": 10}' -H 'Accept: application/json'
   #+end_example
