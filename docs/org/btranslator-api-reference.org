...
** statistics
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/report/statistics.php]]
...
** project_stats
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/report/project_stats.php]]
...
** topcontrib
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/report/topcontrib.php]]
...
** get_random_sguid
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/translations/sguid.php]]
...
** get
   ...
   - [[http://dev.btranslator.org/api-examples-php/translations/get.php]]
...
** add
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/translations/add.php]]
...
** vote
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/translations/vote.php]]
...
** search
  ...
  Examples:
  - [[http://dev.btranslator.org/api-examples-php/translations/search.php]]
...
** submit
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/translations/submit.php]]
...
** import
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/translations/import.php]]
...
** subscribe
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/project/subscribe.php]]
...
** list/all
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/project/list_all.php]]
...
** list
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/project/list.php]]
...
** export
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/project/export.php]]
...
** import
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/project/import.php]]
...
** delete
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/project/delete.php]]
...
** list
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/vocabulary/list.php]]
   ...
   curl -s http://dev.btranslator.org/vocabulary/list | python -m json.tool
   #+END_EXAMPLE
...
** export
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/vocabulary/export.php]]
...
** import
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/vocabulary/import.php]]
...
** add_string
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/vocabulary/add_string.php]]
...
** delete
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/vocabulary/delete.php]]
...
** latest
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/misc/latest.php]]
...
** rss-feed
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/misc/rss-feed.php]]
...
** twitter
   ...
   *Note:* This can be used in combination with /cli twitter
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/misc/twitter.php]]
...
** autocomplete
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/misc/autocomplete.php]]
