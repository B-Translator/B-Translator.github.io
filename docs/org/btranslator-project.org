...
*** project
    + project/list ([/origin[/project[/format]]])
    + project/export (/origin/project/language)
    + project/export_tgz (/origin/project/language)
    + project/diff (/origin/project/lng[/nr[/ediff]])
...
**** Making a snapshot (make_snapshot.sh)
     ...
     =project/diff/origin/project/lng/-= to generate the
