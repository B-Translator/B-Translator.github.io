...
** add_string
   ...
   Examples:
   - [[http://dev.btranslator.org/api-examples-php/project/add_string.php]]
   - [[http://info.btranslator.org/api-examples-js/#project/add_string.js]]
...
** vocabulary/export
   ...
   + GET vocabulary/export/$vocabulary[/$format] ::
     ...
     - [[http://info.btranslator.org/api-examples-js/#misc/vocabulary.js]]
